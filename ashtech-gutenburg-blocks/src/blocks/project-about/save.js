        ...
        <section id="about" className="project-about">
            ...
            <div className="project-about__container">
                <div className="project-about__left">
                    <RichText.Content tagName="span" className="project-about__label animate-text" value={label} />
                    <RichText.Content tagName="h2" className="project-about__title animate-text" value={title} />
                </div>
                <div className="project-about__right">
                    <RichText.Content tagName="p" className="project-about__description animate-text" value={description} />
