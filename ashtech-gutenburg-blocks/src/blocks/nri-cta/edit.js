            ...
            <section className="nri-cta">
                ...
                <div className="nri-cta__container">
                    <div className="nri-cta__left">
                        <RichText tagName="h2" className="nri-cta__title animate-text" value={title} onChange={(value) => setAttributes({ title: value })} placeholder="Title..." allowedFormats={['core/bold', 'core/italic']} />
                    </div>
                    <div className="nri-cta__right">
                        <RichText tagName="p" className="nri-cta__description animate-text" value={description} onChange={(value) => setAttributes({ description: value })} placeholder="Description..." allowedFormats={['core/bold', 'core/italic']} />
