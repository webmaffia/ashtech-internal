            ...
            <section className="contact-offices">
                <div className="contact-offices__container">
                    <div className="contact-offices__header">
                        <RichText tagName="h2" className="contact-offices__title" value={title} onChange={(value) => setAttributes({ title: value })} placeholder="Title..." />
                    </div>
                    
                    <div className="contact-offices__content">
                        <div className="contact-offices__card">
                            <div className="contact-offices__image"><img src="assets/images/contact/office-corporate.jpg" alt="Corporate Office" /></div>
                        ...
                        <div className="contact-offices__card">
                            <div className="contact-offices__image contact-offices__image--site"><img src="assets/images/contact/office-site.jpg" alt="Site Office" /></div>
                            <div className="contact-offices__info">
