        ...
        <div {...useBlockProps.save()}>
            ...
            <section className="project-hero contactbg">
                ...
                <div className="project-hero__content">
                    <RichText.Content tagName="h1" className="project-hero__title" value={heroTitle} />
                    <div className="project-hero__subtitle">
                        <RichText.Content tagName="p" className="project-hero__subtitle-main" value={heroSubtitle} />
                    </div>
                </div>
            </section>
                                    ...
                                    <div className="contact-offices__detail-item">
                                        ...
                                        <div className="contact-offices__text-wrapper">
                                            <a href={`tel:${corporatePhone.replace(/\s/g, '')}`} className="contact-offices__text">
                                                <RichText.Content value={corporatePhone} />
                                            </a>
                                        </div>
                                    </div>
                                    <div className="contact-offices__detail-item">
                                        ...
                                        <div className="contact-offices__text-wrapper">
                                            <a href={`mailto:${corporateEmail}`} className="contact-offices__text">
                                                <RichText.Content value={corporateEmail} />
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div className="contact-offices__detail-item">
                                        ...
                                        <div className="contact-offices__text-wrapper">
                                            <a href={`mailto:${siteEmail}`} className="contact-offices__text">
                                                <RichText.Content value={siteEmail} />
                                            </a>
                                        </div>
                                    </div>
                                </div>
